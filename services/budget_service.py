...
class BudgetService:
    @staticmethod
    def get_cost_centers(enterprise_id):
    ...
    @staticmethod
    def get_budget_status(enterprise_id, cost_center_id, year, month):
        """
    ...
    @staticmethod
    def check_funds_for_po(enterprise_id, cost_center_id, amount):
        """
        Verifica si hay fondos para aprobar una Orden de Compra.
        """
        now = datetime.datetime.now()
        status = BudgetService.get_budget_status(enterprise_id, cost_center_id, now.year, now.month)
    ...
    @staticmethod
    def commit_funds(enterprise_id, transaction_type, transaction_id, cost_center_id, amount):
        """
